...
public class PlatformerCharacter2D : MonoBehaviour
{
    ...
    float groundedRadius = .01f;    // Radius of the overlap circle to determine if grounded
    ...
    void Awake()
    {
        ...
        // Get CircleCollider2D radius as groundedRadius
        groundedRadius = GetComponent<CircleCollider2D>().radius;
    }
